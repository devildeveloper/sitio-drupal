...
$(document).ready(function(){
 ...
 var url = "formulario.php"; // El script a dónde se realizará la petición.
    $.ajax({
           ...
           {
			   $("#ocultartemierda").hide();
               $("#suscritoya").show().fadeIn(500); // Mostrar la respuestas del script PHP.
           }
         });
 ...
 var url = "contactar.php"; // El script a dónde se realizará la petición.
    $.ajax({
           type: "POST",
           url: url,
           data: $("#contactando").serialize(), // Adjuntar los campos del formulario enviado.
           success: function(data)
           {
			   $("#ocultaryapese").hide();
               $("#message").html("Gracias por Contactarnos ! Nos comunicaremos en breve.").fadeIn(500); // Mostrar la respuestas del script PHP.
           }
         });
